...
//     pub async fn read_frame(&mut self) -> crate::Result<Option<Box<dyn MessageDyn>>> {
//         loop {
...
//     fn parse_frame(&mut self) -> crate::Result<Option<Box<dyn MessageDyn>>> {
